...
#--------------------------------------------------#
#   单次卷积'valid' if kwargs.get('strides')==(2,2) else 'same'
#--------------------------------------------------#
@wraps(Conv2D)
...
def mobilenet_body(x):
    ...
    x = DConv2D_BN_Leaky(16, (3, 3), strides=(1, 1))(x)
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DConv2D_BN_Leaky(32, (3, 3), strides=(2, 2))(x)
    x = ZeroPadding2D(((1, 1), (1, 1)))(x)
    x = DConv2D_BN_Leaky(32, (3, 3), strides=(1, 1))(x)
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DConv2D_BN_Leaky(32, (3, 3), strides=(2, 2))(x)
    x = ZeroPadding2D(((1, 1), (1, 1)))(x)
    x = DConv2D_BN_Leaky(32, (3, 3), strides=(1, 1))(x)
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DConv2D_BN_Leaky(64, (3, 3), strides=(2, 2))(x)
    x = ZeroPadding2D(((1, 1), (1, 1)))(x)
    x = DConv2D_BN_Leaky(64, (3, 3), strides=(1, 1))(x)
    return x
